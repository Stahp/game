...
//        jeu = new Jeu(new String[]{"Guybrush", "Largo", "LeChuck", "Elaine"});
		jeu = new Jeu(new String[] { "Guybrush" });
	...
	/**
	 * Ajoute une nouvelle instruction à la file d'instructions (cette méthode est
	 * appelée lorsqu'un message est reçue sur la websocket)
	 * 
	...
	/**
	 * Retire un client de la liste (cette méthode est appelée lorsqu'une connexion
	 * est fermée)
	 * 
